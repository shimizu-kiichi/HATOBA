...
- **平和堂は、40代以下の利用者の割合が他スーパーと比べて少ない傾向にある。**

そこで本プロジェクトでは、ターゲットを **一人暮らしの大学生** に絞り込んだ。一人暮らしの大学生には次のような背景がある。

- 自炊は面倒なのでしたくない。
- かといって、夕食をコンビニや外食で済ませると食費が高くついてしまう。

「自炊はしたくない、でも外食・コンビニは高い」というジレンマを、平和堂の
**賞味期限間近の食材 × イートインスペース** という既存アセットで解決し、
同時に平和堂の若年層の取り込み・フードロス削減につなげることを目指す。
